  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto grid w-full max-w-[1400px] gap-6 px-4 py-6 sm:gap-8 sm:px-6 sm:py-9 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.15fr)] lg:items-start lg:gap-10 lg:px-8 lg:py-12">
            ...
            {HERO_SLIDES.map((slide, i) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-3 max-w-[34rem] text-[0.9375rem] leading-relaxed text-pretty text-[color:var(--scl-hero-muted)] sm:mt-5 sm:text-[1.05rem]">
                    {slide.body}
                  </p>
        ...
        {board ? (
          <div className="relative min-w-0 pb-4 sm:pb-6 lg:pb-6">{board}</div>
        ) : null}
      </div>
    </section>
  );
