...
export function CompetitionHero() {
  ...
  return (
    ...
    >
      {/* Full-bleed art — atmosphere spans the frame; cover fills without left letterbox */}
      <picture className="pointer-events-none absolute inset-0">
        ...
        <img
          ...
          height="1920"
          fetchPriority="high"
          className="size-full object-cover object-center opacity-95 sm:object-[center_right]"
        />
      </picture>
      ...
      <div
        aria-hidden
        className="absolute inset-0 bg-gradient-to-r from-[color:var(--scl-ink-950)]/40 via-[color:var(--scl-ink-950)]/10 to-transparent"
      />
      <div
        aria-hidden
        className="absolute inset-0 bg-gradient-to-t from-[color:var(--scl-ink-950)]/40 via-transparent to-[color:var(--scl-ink-950)]/10"
      />
