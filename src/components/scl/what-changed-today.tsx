 ...
 * Empty compresses to one open line (~96–120px) so absence does not dominate.
 */
  ...
  if (!moves.length) {
    return (
      <section className={cn(className)} aria-label="What changed today">
        <p
          className="text-muted-foreground border-border flex min-h-12 items-center gap-2.5 border-y py-3 text-sm leading-snug"
          role="status"
        >
          <Activity
