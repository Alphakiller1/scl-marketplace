/**
 * SCL trophy mark — conviction pink (scarce identity signal).
 * Token-driven so it follows dark/light pink values.
 */
export function SclLogo({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      {/* stem + base */}
      <path d="M14.6 21.1h2.8l-.3 3h-2.2z" fill="var(--scl-pink)" />
      <rect
        x="11.3"
        y="24.1"
        width="9.4"
