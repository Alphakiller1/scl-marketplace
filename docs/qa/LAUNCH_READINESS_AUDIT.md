...
| 2   | **Default admin credentials** (`admin@scl.local` / `admin1234`) | Documented in-repo (now public); trivially guessable                                                             | Rotate to a strong unique password + real email before launch                                                                             |
